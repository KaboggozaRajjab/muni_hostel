<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
					...
					<li><a href="manage-rooms.php"><i class="fa fa-desktop"></i>Dean Of Students</a>
					<ul>
						<li><a href="add_managers.php">Add Dean Of Students</a></li>
						<li><a href="manage-managers.php">Manage Dean Of Students</a></li>
					</ul>
				</li>
